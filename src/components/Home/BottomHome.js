            ...
            <div className="intro_container">
              ...
              <div className="intro_tabs">
                <div className="news_bubble">
                    ...
                    <button onClick={() => this.props.history.push('/feed')} className="main_button_tab">Feed</button>
                </div>
                <div className="friends_bubble">
                    <img className="friends_img" src={chat} alt=""/>
                    <button onClick={() => this.props.history.push('/chat')} className="main_button_tab">Chat</button>
                </div>
                <div className="space_station_bubble">
                    <img className="ss_img" src={apod} alt=""/>
                    <button onClick={() => this.props.history.push('/apod')} className="main_button_tab">APOD</button>
                </div>
              </div>
